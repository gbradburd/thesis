...
%	compile w/ LaTeX
%	compile w/ bibtex
%	compile w/ pdflatexmk
%	compile w/ bibtex
%	compile w/ pdflatexmk
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	TO-DO
%	track down missing refs
%	fix quotes and other stuff in IBE
%	write abstract (steal from Fitch?  or DDIG?)
%	acknowledgements (maybe remove from chapters?)
